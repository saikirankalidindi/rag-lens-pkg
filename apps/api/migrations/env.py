...
Uses the sync DATABASE_SYNC_URL from app settings so migrations run outside
the async event loop (standard Alembic behaviour).
"""
import sys
...
# Override the DB URL from our app settings (supports .env files)
